...
<body>
<h4 > AIUB currently operates under four distinct Faculties:</h4>
...
<br><br>
<button><a href="aboutus.php">Go" About us "Page </button><button><a href="HomePage.php">Go To HomePage </button>
</body>
</head>
</html>